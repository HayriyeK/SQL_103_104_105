...
insert into child values(105,3000,'Motor','Haşim');//bu sebeple bu kod calişmaz
...
-- child tablo silin meden parent tablo silinemez
...
--child tablodaki veriyi silmeden parent tablodaki veriyi silebldik
--ON DELETE CASCADE
delete from parent2;

--SORU2: parent2 tablosunu siliniz
--ON DELETE CASCADE sayesinde child tablo silinmeden Prent tablo silinebildi.
